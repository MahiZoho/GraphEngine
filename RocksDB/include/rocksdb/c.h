...
typedef struct rocksdb_column_family_handle_list_t rocksdb_column_family_handle_list_t;
typedef struct rocksdb_redis_lists_t rocksdb_redis_lists_t;
...
typedef struct rocksdb_column_family_handle_struct_array_t rocksdb_column_family_handle_struct_array_t;
typedef struct rocksdb_data_t rocksdb_data_t;
...
extern ROCKSDB_LIBRARY_API rocksdb_t* rocksdb_open_column_families_default_options(
...
extern ROCKSDB_LIBRARY_API rocksdb_t* rocksdb_open_column_families_default_options_zlabs(
    const rocksdb_options_t* db_options,
    const char* name,
    int num_column_families,
    char** column_family_names,
...
extern ROCKSDB_LIBRARY_API void rocksdb_column_family_handle_list_destroy(rocksdb_column_family_handle_struct_array_t *columnFamilyHandleList);
...
extern ROCKSDB_LIBRARY_API rocksdb_column_family_handle_t*
rocksdb_create_column_family_zlabs(rocksdb_t* db,
                             const rocksdb_options_t* column_family_options,
                             const char* column_family_name, rocksdb_column_family_handle_struct_array_t **columnFamilyHandleList, char** errptr);

extern ROCKSDB_LIBRARY_API rocksdb_column_family_handle_t* rocksdb_GetColumnFamilyHandle(rocksdb_column_family_handle_struct_array_t *columnFamilyHandleList, const char *column_family_name);
...
// extern ROCKSDB_LIBRARY_API rocksdb_column_family_handle_t* rocksdb_getColumnFamilyHandle(
//     rocksdb_t* db, 
//     const rocksdb_options_t* column_family_options, 
...
//Key-Value(Lists) Related functions...
extern ROCKSDB_LIBRARY_API rocksdb_redis_lists_t* rocksdb_redis_lists_create(
    const char* name, rocksdb_t* db, const rocksdb_writeoptions_t* writeoptions, const rocksdb_readoptions_t* readoptions);

extern ROCKSDB_LIBRARY_API void rocksdb_redis_lists_push_left(
    rocksdb_redis_lists_t* redisLists, rocksdb_column_family_handle_t* column_family, const char* key,
    const char* val, char** errptr);

// extern ROCKSDB_LIBRARY_API int rocksdb_redis_lists_get_data(rocksdb_redis_lists_t* redisLists,
//     rocksdb_column_family_handle_t* column_family_handle,
//     const char* key, 
//     char** data, 
//     char** errptr);

extern ROCKSDB_LIBRARY_API rocksdb_data_t* rocksdb_redis_lists_get_data(rocksdb_redis_lists_t* redisLists,
    rocksdb_column_family_handle_t* column_family_handle,
    const char* key, 
    char** errptr);

extern ROCKSDB_LIBRARY_API void rocksdb_destroy_data(rocksdb_data_t *listdata);

extern ROCKSDB_LIBRARY_API rocksdb_data_t* rocksdb_redis_lists_get_common_data(rocksdb_redis_lists_t* redisLists, rocksdb_column_family_handle_t* column_family, 
    const char* key1, const char* key2, char** errptr);

extern ROCKSDB_LIBRARY_API void rocksdb_redis_lists_print(
    rocksdb_redis_lists_t* redisLists, rocksdb_column_family_handle_t* column_family, const char* key);

extern ROCKSDB_LIBRARY_API void rocksdb_redis_lists_close(rocksdb_redis_lists_t* redisLists);
